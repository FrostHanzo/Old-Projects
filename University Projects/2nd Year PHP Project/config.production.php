...
define('DB_HOST', 'mysql.zhivankin.com');
define('DB_NAME', 'zhivankin_com');
define('DB_USER', 'zhivankincom');
define('DB_PASS', 'Af*!fN7i');
...
define('MAX_FILE_SIZE', 2097152);
// the path of the uploads directory
